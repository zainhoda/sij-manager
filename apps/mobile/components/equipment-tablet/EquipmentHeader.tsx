...
export function EquipmentHeader({ equipment, lastRefresh, isRefreshing }: EquipmentHeaderProps) {
  ...
  const statusColor = STATUS_COLORS[equipment.status] || colors.gray[400];
  const statusLabel = STATUS_LABELS[equipment.status] || equipment.status;

  return (
    <View style={styles.container}>
      <View style={styles.leftSection}>
        <Text style={styles.equipmentName}>{equipment.name.toUpperCase()}</Text>
